"""Streamlit multipage entry for ERD Explorer."""
...
from erd_explorer import render_erd_explorer
...
st.set_page_config(
    page_title="ERD Explorer · DEMIS Schema Analyzer",
    page_icon="🕸️",
    layout="wide",
)
...
render_erd_explorer(targets=targets, api_get=api_get)
